...
class DepthEstimationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        frameAnalyser = FrameAnalyser(MidasNetSmall(MapType.DEPTHVIEW_GRAYSCALE), viewDepth!!,0)
        ...
        spinner!!.onItemSelectedListener =  object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                frameAnalyser = FrameAnalyser(MidasNetSmall(MapType.DEPTHVIEW_GRAYSCALE), viewDepth!!,position)
...
//        originalView!!.setSurfaceProvider(viewOriginal!!.surfaceProvider)
        ...
        val rese = Size(viewDepth!!.width, viewDepth!!.height)
